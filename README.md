...
<div align="center">
  <!-- You are encouraged to replace this logo with your own! Otherwise you can also remove it. -->
    <br>
  <h1 style="font-size: 35px; color: lightblue"><b>Awesome Books ES6</b></h1>
...
# 📖 Awesome Books <a id="about-project"></a>

**Awesome Books** is a bookstore app designed mobile first which serves to list available books and add new ones through a form. It's purpose is to demonstrate a one-page webside implemented using Javascript ES6 and modular capabilities to load different pages in one web page with the rest of the page remained unchanged.
...
<details>
  ...
  <ul>
    ...
    <li><a href="https://moment.github.io/luxon/">Luxon Date Library</a></li>
  </ul>
</details>
<br/>
<!-- Features -->
...
- **Display the available books from localStorage**
- **Add new books through a form**
- **One page app (loads modules to load different sections)**
- **Mobile first design**
...
- An implementation of this portfolio is live on [Github Pages](https://dev89s.github.io/awesome-books-es6/)
...
### Setup
  ...
  2. Use "git" to clone this repository into your local drive:
      >```$ git clone https://github.com/dev89s/awesome-books-es6.git```

### Usage

  - To be able to any features to the project's current state use this command:
    > ```$ git checkout modular-design```
...
I would like to thank Microverse online web development school for providing the material and guidlines that helped me created this app.
